 ...
 */
class MapView extends (0, _NativeBridgeComponent.default)(_react.default.PureComponent, NATIVE_MODULE_NAME) {
  static defaultProps = {
    projection: 'mercator',
    scrollEnabled: true,
    pitchEnabled: true,
  ...
  _setHandledMapChangedEvents(props) {
    if ((0, _utils.isAndroid)() || MGLModule.MapboxV10) {
      const events = [];
...
const RCTMGLMapView = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME);
let RCTMGLAndroidTextureMapView;
if ((0, _utils.isAndroid)()) {
  RCTMGLAndroidTextureMapView = (0, _reactNative.requireNativeComponent)(ANDROID_TEXTURE_NATIVE_MODULE_NAME);
}
